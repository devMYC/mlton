...
static double pid_update(GC_state s, double measurement, double dt);
static double pid_update2(GC_state s, double measurement, double dt, double minOut, double maxOut);
